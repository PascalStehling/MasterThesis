...
\email{stehling.pascal@gmail.com}
\matrnr{455051}
\bdate{18.12.1997}
\bcity{Hünfeld}
\supervisor{Prof.~Dr.~habil.~Andreas Ahrens}
\secsupervisor{Prof.~Dr.~Antje~Raab-Düsterhöft}
...
% Glossar einbinden
% dont remove, for some reason the build breaks
...
% \maketask{\input{chapter/TaskDefinition.tex}}

\makeabstract{\input{chapter/Abstract.tex}}
...
\input{chapter/MathematicalBackground.tex}
\input{chapter/LWE.tex}
\input{chapter/HomomorphicEncryption.tex}
...
% Put List of Figures and Tables on one Page
...
\begin{appendices}
  ...
  \input{appendix/example-calculations.tex}
